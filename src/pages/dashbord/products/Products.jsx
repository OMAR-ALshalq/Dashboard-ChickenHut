...
export default function Products() {
  ...
  const uploadImage = async (file, inputEl) => {
    ...
    try {
      const res = await axios.post(
        "https://api.cloudinary.com/v1_1/bgcalm2q/image/upload",
        formData
      );
  ...
  // إرسال النموذج (إضافة أو تعديل) - بدون أحجام
  ...
  return (
    <div>
      ...
      {/* مودال إضافة / تعديل صنف - بدون قسم الأحجام */}
